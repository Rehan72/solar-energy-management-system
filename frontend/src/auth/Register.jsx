    ...
    return (
      <div className="space-y-6">
        <div className="bg-solar-card rounded-lg p-8 energy-card text-center">
          ...
          <p className="text-solar-muted mb-6">Your account has been created. Please login to complete your solar profile setup.</p>
  ...
  return (
    <div className="space-y-6">
      <div className="text-center mb-6">
        ...
        <p className="text-solar-muted">Enter your details to get started</p>
      </div>
